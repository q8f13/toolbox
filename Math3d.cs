...
/// <summary>
/// 3d math caclulations
/// from : http://wiki.unity3d.com/index.php/3d_Math_functions
/// This code is not optimized for performance yet. If you need to call one or more of these functions thousands of times per frame
/// , follow the the guidelines here: http://www.performancesimulations.com/wp/how-to-get-big-speed-increases-in-unitys-physics-or-any-math-heavy-code/
/// </summary>
...
//			Vector3 crossVec3and1 = Vector3.Cross(lineVec3, lineVec1);
	 
			float planarFactor = Vector3.Dot(lineVec3, crossVec1and2);

//			Debug.DrawRay(linePoint1, Vector3.up * 5f, Color.green, 99f);
//			Debug.DrawRay(linePoint2, Vector3.up * 5f, Color.blue, 99f);
	 
			//is coplanar, and not parrallel
			if(Mathf.Abs(planarFactor) < 0.0001f && crossVec1and2.sqrMagnitude > 0.0001f)
			{
				float s1 = Vector3.Dot(crossVec3and2, crossVec1and2) / crossVec1and2.sqrMagnitude;
//				float s2 = Vector3.Dot(crossVec3and1, crossVec1and2) / crossVec1and2.sqrMagnitude;
				intersection = linePoint1 + (lineVec1 * s1);
				return true;
			}
			else
			{
